...
const askGroq = async (message, language = "english") => {
  let languageInstruction = "";

  if (language === "english") {
    languageInstruction = `
    Reply ONLY in English.
    Keep the answer short, friendly, and WhatsApp-friendly.
`;
...
`;
    ...
    languageInstruction = `
    Always understand the user's language and intent.
    Generate the response ONLY in simple English.
    The English response should be short, natural, and easy to translate into Konkani.
`;
  }
